...
include_once './../islogado.php';
include_once './../conectarbanco2.php';

$db = new Database();
$app = $db->select('app', ['id' => 1])[0];
$usuario = $db->select('appconfig', ['email' => $_SESSION['email']])[0];
    ...
    <div>
        ...
        <section id="hero" class="hero-section dark wf-section">
            <div class="minting-container w-container">
                ...
                <p>Saldo: <?=  number_format($usuario['saldo'],2,',','.')  ?><br>
                </p>
                <form data-name="" id="payment_pix" name="payment_pix" method="post" action="./process-saque.php" aria-label="Form">
                    <div class="properties">
                        ...
                        <div class="rarity-row roboto-type2">
                            <input type="number" data-name="Valor de saque" min="<?= $app['saques_min'] ?>" max="<?= $usuario['saldo'] ?>" name="withdrawValue" id="withdrawValue" value="0.00" pattern="[0-9]" step="1" required="" class="large-input-field w-node-_050dfc36-93a8-d840-d215-4fca9adfe60d-9adfe605 w-input">
                        </div>
                    </div>
                    <div class="">
                        ...
                        <p>Ao solicitar saque você concorda com os
                            <a href="../legal/">
                                termos de serviço</a> e a <br>taxa de <?= $app['taxa_saque'] ?>% </span>
                        </p>
                    </div>
                </form>
...
<script>
    ...
    window.history.pushState({}, '', '/saque/');             
</script>
